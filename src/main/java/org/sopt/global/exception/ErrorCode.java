...
public enum ErrorCode {
    ...
    ATH_401_005(401, "ATH_401_005", "OAuth 인증에 실패했습니다."),
    ATH_401_006(401, "ATH_401_006", "Access Token이 만료되었습니다."),
    ATH_403_001(403, "ATH_403_001", "권한이 없습니다."),
    ATH_409_002(409, "ATH_409_002", "이미 가입된 이메일입니다. 기존 계정으로 로그인해주세요."),
    ATH_500_001(500, "ATH_500_001", "외부 OAuth 서버 통신에 실패했습니다."),
